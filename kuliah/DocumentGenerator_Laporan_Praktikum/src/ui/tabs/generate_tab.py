...
class GenerateTab(BaseTab):
    ...
    def _build(self):
        ...
        ttk.Label(center_frame, text="Laporan Anda Sudah Siap!", font=("Segoe UI", 16, "bold")).pack(pady=10)
        ttk.Label(
            center_frame,
    ...
    def _generate(self):
        ...
        try:
            ...
            self.show_error("Template Tidak Ada", f"File template '{e.args[0]}' tidak ditemukan.")
