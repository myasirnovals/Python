...
from ui.core.style_manager import setup_styles
from ui.tabs.conclusion_tab import ConclusionTab
from ui.tabs.cover_tab import CoverTab
...
class App(TkinterDnD.Tk):
    ...
    def _build_ui(self):
        ...
        canvas_window = content_canvas.create_window((0, 0), window=scrollable_content, anchor="nw")
        ...
        ttk.Label(header_frame, text="v4.2.7", style="Muted.TLabel").pack(side="left", padx=(10, 0), pady=(4, 0))
        ttk.Label(
            header_frame,
            text="AI Assisted",
            background="#dbeafe",
        ...
        notebook_container = ttk.Frame(scrollable_content, padding=(8 if self.is_compact_mode else 10))
